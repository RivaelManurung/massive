...
const Videos = () => {
  ...
  const filteredVideos = videos.filter((video) => {
    ...
    return matchesSearch && (selectedCategory === "Semua" || video.categoryVideoId === selectedCategory);
  });
  ...
  return (
    <div className="p-8 max-w-screen-lg mx-auto">
      ...
      <div className="mb-8">
        <h2 className="text-4xl font-semibold mb-4">Categories Video</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentVideos.length > 0 ? (
          ...
          <p className="text-center text-xl">No videos found for this category.</p>
        )}
      </div>
...
const VideoCard = ({ video, categories, onClick }) => {
  ...
  const category = categories.find((cat) => cat.id === video.categoryVideoId)?.name || "N/A";
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-2xl text-gray-800 font-semibold mb-2">{video.title}</h3>
